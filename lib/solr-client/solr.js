...
Client.prototype.setCollection = function(collection){
	this.options.core = collection ;
};

Client.prototype.getCollection = function(collection){
...
Client.prototype.createAddStream = function(options) {
  var path = [
    this.options.path,
    this.options.core,
    this.UPDATE_JSON_HANDLER + "?" + querystring.stringify(options) + "&wt=json"
  ]
